...
; const YsCesium = (function (W, D, U) {
    ...
    YsCesium.prototype.addCircleScan = function (data) {
        ...
        const CartographicCenter = new Cesium.Cartographic(Cesium.Math.toRadians(data.lon), 
        Cesium.Math.toRadians(data.lat), 0); //中心位子
     ...
     * @constructor
     */
    YsCesium.prototype.Css3Renderer = function (app, elements, isBackHide) {
